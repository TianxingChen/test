...
class TrainDP3Workspace:
    ...
    def run_robot(self):
        ...
        while not done:
            # ...(get obs or stop running policy)
            obs = None # need point_cloud and agent_pose (key: point_cloud, agent_pos), as dict
            action = env_runner.get_action(policy, obs) # may be multi
            # ...(return actions)
